        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    $subPages = 6;  //每页显示的内容数
                    $listID = loginsql($_GET['id']);
                    $begin =  ($page-1)*$subPages;      // 进行调整
                    $result = $conn->query("select a.id,a.title,a.click_num,a.content,a.keyword,a.author,c.class_name,a.c_time from article as a,cate as c where a.cateid=c.id and c.id = $listID order by a.id desc  limit $begin,$subPages");
                    ...
                    <div class="list-page">
                        <?php
                        $result_2 = $conn->query("select * from article as a,cate as c where a.cateid=c.id and c.id = $listID order by a.id desc");
